...
public class LoginServlet extends HttpServlet {
    ...
    private final String UserData_URL = "pages/UserDataScreen/UserData.html";
    private final String SIGN_UP_URL = "index.html";
    private final String LOGIN_ERROR_URL = "/pages/logineror/login_attempt_after_error.jsp";  // must start with '/' since will be used in request dispatcher...
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null ) {
            ...
            else if (userTypeFromParameter == null || userTypeFromParameter.isEmpty())
            {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        response.sendRedirect(UserData_URL);
                    }
                }
            }
        } else {
